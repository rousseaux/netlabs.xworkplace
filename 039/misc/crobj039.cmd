...
/* Config Folder title */
ConfigFolder        = "Cartella di configurazione "||XWorkplace;
/* here come the objects in the config folder */
CommandLines        = "~Richieste comandi";
OS2Win              = "~"||OS2||" - Finestra";
OS2Fullscreen       = OS2||" - ~Schermo intero";
DosWin              = "~DOS - Finestra";
DOSFullscreen       = "DOS - S~chermo intero";
CreateAnother       = "Creare n~uovo";
Folder              = "cartella";
    /* the following three were added with V0.9.16 */
URLFolder           = "cartella URL";
DataFile            = "file dati";
ProgramObject       = "programma";
QuickSettings       = "~Impostazioni veloci";
DefaultView         = "Visualizzazione assunta ~cartella";
IconView            = "Icone";
TreeView            = "Struttura ad albero";
DetailsView         = "Visualizzazione dettagli";
SmallIcons          = "Visualizzazione ad icone e ad albero - icone ridotte";
NormalIcons         = "Visualizzazione ad icone e ad albero - icone normali";
ShowAllInTreeView   = "Mostrare tutti gli oggetti nella vista ad albero";
WorkplaceShell      = "Workplace Shell";
XWPSetup            = "Impostazioni "||XWorkplace;
OS2Kernel           = "Kernel "||OS2;
Screen              = "Schermo";
Mouse               = "Mouse";
Keyboard            = "Tastiera";
/* the following one is new with V0.9.19 */
OnlineReference     = "Guida ad "||XWorkplace;
Treesize            = "Dimensione totale cartella";
PackTree            = "Archivia cartella (zip)";
