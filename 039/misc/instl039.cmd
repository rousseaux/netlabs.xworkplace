...
/* Title of the Desktop folder; choose a faily long title,
   ...
   exists */
XFolderMain         = XWorkplace||" - Cartella di installazione";
/* "Introduction" object (SmartGuide) */
XFolderIntro        = "Introduzione";
OnlineReference     = "Guida ad "||XWorkplace;
/* other objects */
WorkplaceShell      = "Workplace Shell";
XWPSetup            = "Impostazioni "||XWorkplace;
XWPClassList        = "Elenco classi WPS";
OS2Kernel           = "Kernel "||OS2;
Screen              = "Schermo";
Media               = "Multimedia";
String              = "Stringhe impostazioni";
Mouse               = "Mouse";
Keyboard            = "Tastiera";
Sound               = "Suono";
XShutdown           = "Chiusura avanzata...";
/* font folder added with V0.9.7 */
FontFolder          = "Tipi di carattere";
