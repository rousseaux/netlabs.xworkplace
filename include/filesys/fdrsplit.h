 ...
 */
     ...
     *      
     *@@changed V1.0.9 (2011-09-24) [rwalsh]: replaced FM2_ADDFIRSTCHILD_BEGIN/NEXT/DONE
     */

    #define FM2_ADDFIRSTCHILDREN    (WM_USER + 11)

    /*
     *@@FM_INSERTFOLDER and FM_INSERTOBJECT:
     *      notify the tree and files containers respectively
     *      of a folder or other object that may need to be
     *      inserted in the container.
     *
     *      Both are posted primarily by fdrSplitInsertObject
     *      for a newly awakened object.  FM_INSERTFOLDER may
     *      also be posted by the split-populate thread while
     *      FM_INSERTOBJECT may be sent by the tree container
     *      when handling an FM_INSERTFOLDER message.
     *
    ...
    #define FM_INSERTFOLDER         (WM_USER + 1001)
    #define FM_INSERTOBJECT         (WM_USER + 1002)
    ...
    #define SN_VKEY                 0x1005
        ...
        typedef struct _FDRSPLITVIEW
        {
            ...
            HWND            hwndSplitWindow,    // child of hwndMainControl
                            ...
                            hwndFocusCnr;       // container with focus
        ...
        ULONG fdrInsertContents(WPFolder *pFolder,
                                HWND hwndCnr,
