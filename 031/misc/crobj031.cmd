...
/* Config Folder title */
ConfigFolder        = XWorkplace||" Configuratie map";
/* here come the objects in the config folder */
CommandLines        = "~Opdracht aanwijzingen";
OS2Win              = "~"||OS2||" venster";
OS2Fullscreen       = OS2||" ~volledig scherm";
DosWin              = "~DOS venster";
DOSFullscreen       = "DOS volledig scherm";
CreateAnother       = "Toevoege~n";
Folder              = "Map";
    /* the following three were added with V0.9.16 */
URLFolder           = "URL Map";
DataFile            = "Gegevens bestand";
ProgramObject       = "Programma object";
QuickSettings       = "~Snelle instellingen";
DefaultView         = "Stan~daard weergave voor deze map";
IconView            = "Pictogrammen";
TreeView            = "Boomstructuur";
DetailsView         = "Details";
SmallIcons          = "Kleine pictogrammen voor Pictogrammen en Boomstructuur weergave";
NormalIcons         = "Normale pictogrammen voor Pictogrammen en Boomstructuur weergave";
ShowAllInTreeView   = "Toon alle objecten in Boomstructuur";
...
OnlineReference     = XWorkplace||" Gebruikers Handleiding";
Treesize            = "Boomstructuur grootte";
PackTree            = "Deze boomstructuur zippen";
