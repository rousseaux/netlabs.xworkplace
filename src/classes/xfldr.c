                                                 ...
                                                 BOOL fMultiSelect)
{
    ...
    flMenuFilter = XFolder_parent_WPFolder_wpFilterPopupMenu(somSelf,
                                                             ...
                                                             hwndCnr,
                                                             fMultiSelect);
    PMPF_MENUS(("flags %08X, parent flags: %08X, ", ulFlags, flMenuFilter));
 ...
 *@@changed V1.0.9 (2011-09-24) [rwalsh]: moved Splitview container-insertion code to fdrsplit.c @@fixes 2
 *@@changed V1.0.9 (2011-09-24) [rwalsh]: removed Splitview support's dependency on Turbo folders @@fixes 2
 */
                                          ...
                                          WPObject* Object)
{
    ...
    // insert object into any open Splitview for this folder
    fdrSplitInsertObject(somSelf, Object);
