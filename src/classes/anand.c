 ...
 *
 *      -- XWPAnimouse: WPDataFile subclass for *.and animation files.
 *
 *@@added V0.9.3 (2000-05-21) [umoeller]
 *@@somclass XWPAnimouse and_
 *@@somclass M_XWPAnimouse andM_
 */
...
#ifndef SOM_Module_anand_Source
#define SOM_Module_anand_Source
#endif
#define XWPAnimouse_Class_Source
#define M_XWPAnimouse_Class_Source
...
SOM_Scope void SOMLINK and_xwpRefreshFileIcon(XWPAnimouse * somSelf)
{
    ...
    do
    {
        ...
        if (hptr)
        {
            ...
            XWPAnimouse_parent_WPDataFile_wpSetIcon(somSelf, hptr);
                                                   ...
                                                   HWND hwndNotebook)
{
    ...
    XWPAnimouseMethodDebug("XWPAnimouse", "and_wpAddObjectGeneralPage");
    FUNCENTER();
                                         ...
                                         ULONG ulCode, WPObject * refObject)
{
    ...
    XWPAnimouseMethodDebug("XWPAnimouse", "and_wpObjectReady");
    FUNCENTER();

    XWPAnimouse_parent_WPDataFile_wpObjectReady(somSelf, ulCode,
                                               refObject);
...
SOM_Scope HPOINTER SOMLINK and_wpQueryIcon(XWPAnimouse * somSelf)
{
    ...
    XWPAnimouseMethodDebug("XWPAnimouse", "and_wpQueryIcon");
    FUNCENTER();
                                            ...
                                            PICONINFO pIconInfo)
{
    ...
    XWPAnimouseMethodDebug("XWPAnimouse", "and_wpQueryIconData");
    FUNCENTER();
    ...
    return (XWPAnimouse_parent_WPDataFile_wpQueryIconData(somSelf,
                                                         pIconInfo));
}
                                     ...
                                     HPOINTER hptrNewIcon)
{
    ...
    XWPAnimouseMethodDebug("XWPAnimouse", "and_wpSetIcon");
    FUNCENTER();
    ...
    return (XWPAnimouse_parent_WPDataFile_wpSetIcon(somSelf,
                                                   hptrNewIcon));
}
                                         ...
                                         PICONINFO pIconInfo)
{
    ...
    XWPAnimouseMethodDebug("XWPAnimouse", "and_wpSetIconData");
    FUNCENTER();
    ...
    return (XWPAnimouse_parent_WPDataFile_wpSetIconData(somSelf,
                                                       pIconInfo));
}
                                             ...
                                             ULONG iPosition)
{
    ...
    XWPAnimouseMethodDebug("XWPAnimouse", "and_wpModifyPopupMenu");
    FUNCENTER();
    ...
    fSuccess =
        _wpInsertPopupMenuItems(somSelf, hwndMenu, 0,
                                cmnQueryNLSModuleHandle(FALSE),
                                    // _clsQueryResourceModuleHandle(_XWPAnimouse), V0.9.3 (2000-05-21) [umoeller]
    ...
    return (XWPAnimouse_parent_WPDataFile_wpModifyPopupMenu(somSelf,
                                                           hwndMenu,
                                                           hwndCnr,
                                                           iPosition));
}
                                              ...
                                              BOOL fMultiSelect)
{
    ...
    XWPAnimouseMethodDebug("XWPAnimouse", "and_wpFilterPopupMenu");

    ulFlags &= ~CTXT_PRINT;

    return (XWPAnimouse_parent_WPDataFile_wpFilterPopupMenu(somSelf,
                                                           ulFlags,
                                                           hwndCnr,
                                                           fMultiSelect));
}
                                              ...
                                              ULONG ulMenuId)
{
    ...
    XWPAnimouseMethodDebug("XWPAnimouse", "and_wpMenuItemSelected");
    FUNCENTER();
    ...
    switch (ulMenuId)
    {
        ...
        default:
            return (XWPAnimouse_parent_WPDataFile_wpMenuItemSelected(somSelf,
                                                                    hwndFrame,
                                                                    ulMenuId));
    }
                                                  ...
                                                  ULONG MenuId)
{
    ...
    XWPAnimouseMethodDebug("XWPAnimouse", "and_wpMenuItemHelpSelected");
    FUNCENTER();

    // @@todo
    return (XWPAnimouse_parent_WPDataFile_wpMenuItemHelpSelected(somSelf,
                                                                MenuId));
}
...
SOM_Scope void SOMLINK and_wpInitData(XWPAnimouse * somSelf)
{
    ...
    XWPAnimouseMethodDebug("XWPAnimouse", "and_wpInitData");
    FUNCENTER();

    XWPAnimouse_parent_WPDataFile_wpInitData(somSelf);
...
SOM_Scope void SOMLINK and_wpUnInitData(XWPAnimouse * somSelf)
{
    ...
    XWPAnimouseMethodDebug("XWPAnimouse", "and_wpUnInitData");
    FUNCENTER();

    XWPAnimouse_parent_WPDataFile_wpUnInitData(somSelf);     // @@todo
...
SOM_Scope ULONG SOMLINK andM_wpclsQueryStyle(M_XWPAnimouse * somSelf)
{
    ...
    M_XWPAnimouseMethodDebug("M_XWPAnimouse", "andM_wpclsQueryStyle");
...
{
    /* M_XWPAnimouseData *somThis = M_XWPAnimouseGetData(somSelf); */
    M_XWPAnimouseMethodDebug("M_XWPAnimouse", "andM_wpclsQueryInstanceFilter");
    FUNCENTER();
...
{
    /* M_XWPAnimouseData *somThis = M_XWPAnimouseGetData(somSelf); */
    M_XWPAnimouseMethodDebug("M_XWPAnimouse", "andM_wpclsQueryInstanceType");
    FUNCENTER();
...
{
    /* M_XWPAnimouseData *somThis = M_XWPAnimouseGetData(somSelf); */
    M_XWPAnimouseMethodDebug("M_XWPAnimouse", "andM_wpclsQueryTitle");
    FUNCENTER();
...
SOM_Scope void SOMLINK andM_wpclsInitData(M_XWPAnimouse * somSelf)
{
    ...
    M_XWPAnimouseMethodDebug("M_XWPAnimouse", "andM_wpclsInitData");
    FUNCENTER();

    M_XWPAnimouse_parent_M_WPDataFile_wpclsInitData(somSelf);
...
SOM_Scope void SOMLINK andM_wpclsUnInitData(M_XWPAnimouse * somSelf)
{
    ...
    M_XWPAnimouseMethodDebug("M_XWPAnimouse", "andM_wpclsUnInitData");
    FUNCENTER();
    ...
    M_XWPAnimouse_parent_M_WPDataFile_wpclsUnInitData(somSelf);
}
...
MRESULT EXPENTRY wpand_NotebookPageProc(HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2)
{
    ...
    if (pwd)
    {
        ...
        somSelf = pwd->somSelf;
        somThis = XWPAnimouseGetData(somSelf);
    }
                        ...
                        case IDDLG_DLG_ICONPAGE:
                            {
                                ...
                                // set title
                                DLGSETSTRING(hwnd, IDDLG_ME_TITLE, _wpclsQueryTitle(_XWPAnimouse));

                                // mark title field as unchanged
                                DLGQUERYCHANGED(hwnd, IDDLG_ME_TITLE);

                                // query style
                                ulStyle = _wpclsQueryStyle(_XWPAnimouse);
                                _wpSetStyle(somSelf, ulStyle);
