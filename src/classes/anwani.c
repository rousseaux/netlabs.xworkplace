 ...
 *
 *      -- XWPWinAni: WPDataFile subclass for Windows *.ani animation files.
 *
 *@@added V0.9.3 (2000-05-21) [umoeller]
 *@@somclass XWPWinAni wani_
 *@@somclass M_XWPWinAni waniM_
 */
...
#ifndef SOM_Module_anwani_Source
#define SOM_Module_anwani_Source
#endif
...
SOM_Scope void SOMLINK wani_wpRefreshFileIcon(XWPWinAni * somSelf)
{
    ...
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);

    XWPWinAniMethodDebug("XWPWinAni", "wani_wpRefreshFileIcon");
    FUNCENTER();
    ...
    do
    {
        ...
        if (hptr)
        {
            ...
            XWPWinAni_parent_WPDataFile_wpSetIcon(somSelf, hptr);
...
SOM_Scope ULONG SOMLINK wani_wpGetAnimationTimeframeValue(XWPWinAni * somSelf)
{
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);

    XWPWinAniMethodDebug("XWPWinAni", "wani_wpGetAnimationTimeframeValue");
    FUNCENTER();
...
SOM_Scope BOOL SOMLINK wani_wpSetAnimationTimeframeValue(XWPWinAni * somSelf,
                                                         ULONG ulNewValue)
{
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);

    XWPWinAniMethodDebug("XWPWinAni", "wani_wpSetAnimationTimeframeValue");
    FUNCENTER();
...
SOM_Scope ULONG SOMLINK wani_InsertAnimationPage1(XWPWinAni * somSelf,
                                                  HWND hwndDlg)
{
    PAGEINFO pi;
    ...
    XWPWinAniMethodDebug("XWPWinAni", "wani_InsertAnimationPage");
    FUNCENTER();
...
SOM_Scope ULONG SOMLINK wani_InsertAnimationPage2(XWPWinAni * somSelf,
                                                  HWND hwndDlg)
{
    PAGEINFO pi;
    CHAR szTabName[MAX_RES_STRLEN];
    ...
    XWPWinAniMethodDebug("XWPWinAni", "wani_InsertAnimationPage2");
...
SOM_Scope ULONG SOMLINK wani_InsertAnimationPage3(XWPWinAni * somSelf,
                                                  HWND hwndDlg)
{
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);

    XWPWinAniMethodDebug("XWPWinAni", "wani_InsertAnimationPage3");
...
SOM_Scope ULONG SOMLINK wani_wpAddFile1Page(XWPWinAni * somSelf,
                                            HWND hwndNotebook)
{
    ULONG ulResult;
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);

    XWPWinAniMethodDebug("XWPWinAni", "wani_wpAddFile1Page");

    _InsertAnimationPage2(somSelf, hwndNotebook);
    _InsertAnimationPage1(somSelf, hwndNotebook);

    ulResult = XWPWinAni_parent_WPDataFile_wpAddFile1Page(somSelf,
                                                               hwndNotebook);
...
SOM_Scope ULONG SOMLINK wani_wpAddObjectGeneralPage(XWPWinAni * somSelf,
                                                    HWND hwndNotebook)
{
    PAGEINFO pi;
    CHAR szTabName[MAX_RES_STRLEN];
    ...
    XWPWinAniMethodDebug("XWPWinAni", "wani_wpAddObjectGeneralPage");
    FUNCENTER();
...
SOM_Scope void SOMLINK wani_wpObjectReady(XWPWinAni * somSelf,
                                          ULONG ulCode, WPObject * refObject)
{
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);

    XWPWinAniMethodDebug("XWPWinAni", "wani_wpObjectReady");
    FUNCENTER();

    XWPWinAni_parent_WPDataFile_wpObjectReady(somSelf, ulCode,
                                                   refObject);
...
SOM_Scope HPOINTER SOMLINK wani_wpQueryIcon(XWPWinAni * somSelf)
{
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);

    XWPWinAniMethodDebug("XWPWinAni", "wani_wpQueryIcon");
    FUNCENTER();
    ...
    return (XWPWinAni_parent_WPDataFile_wpQueryIcon(somSelf));
}

// ===========================================================================

SOM_Scope ULONG SOMLINK wani_wpQueryIconData(XWPWinAni * somSelf,
                                             PICONINFO pIconInfo)
{
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);

    XWPWinAniMethodDebug("XWPWinAni", "wani_wpQueryIconData");
    FUNCENTER();
    ...
    return (XWPWinAni_parent_WPDataFile_wpQueryIconData(somSelf,
                                                             pIconInfo));
}

// ===========================================================================

SOM_Scope BOOL SOMLINK wani_wpSetIcon(XWPWinAni * somSelf,
                                      HPOINTER hptrNewIcon)
{
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);

    XWPWinAniMethodDebug("XWPWinAni", "wani_wpSetIcon");
    FUNCENTER();
    ...
    return (XWPWinAni_parent_WPDataFile_wpSetIcon(somSelf,
                                                       hptrNewIcon));
}

// ===========================================================================

SOM_Scope BOOL SOMLINK wani_wpSetIconData(XWPWinAni * somSelf,
                                          PICONINFO pIconInfo)
{
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);

    XWPWinAniMethodDebug("XWPWinAni", "wani_wpSetIconData");
    FUNCENTER();
    ...
    return (XWPWinAni_parent_WPDataFile_wpSetIconData(somSelf,
                                                           pIconInfo));
}

// ===========================================================================

SOM_Scope BOOL SOMLINK wani_wpModifyPopupMenu(XWPWinAni * somSelf,
                                              HWND hwndMenu,
                                              HWND hwndCnr,
                                              ULONG iPosition)
{
    ...
    XWPWinAniMethodDebug("XWPWinAni", "wani_wpModifyPopupMenu");
    FUNCENTER();
    ...
    fSuccess =
        _wpInsertPopupMenuItems(somSelf, hwndMenu, 0,
                                cmnQueryNLSModuleHandle(FALSE), // _clsQueryResourceModuleHandle(_XWPWinAni), V0.9.3 (2000-05-21) [umoeller]
    ...
    return (XWPWinAni_parent_WPDataFile_wpModifyPopupMenu(somSelf,
                                                               hwndMenu,
                                                               hwndCnr,
                                                               iPosition));
}
...
SOM_Scope ULONG SOMLINK wani_wpFilterPopupMenu(XWPWinAni * somSelf,
                                               ULONG ulFlags,
                                               HWND hwndCnr,
                                               BOOL fMultiSelect)
{
    ...
    XWPWinAniMethodDebug("XWPWinAni", "wani_wpFilterPopupMenu");

    ulFlags &= ~CTXT_PRINT;

    return (XWPWinAni_parent_WPDataFile_wpFilterPopupMenu(somSelf,
                                                               ulFlags,
                                                               hwndCnr,
                                                               fMultiSelect));
}
...
SOM_Scope BOOL SOMLINK wani_wpMenuItemSelected(XWPWinAni * somSelf,
                                               HWND hwndFrame,
                                               ULONG ulMenuId)
{
    ...
    XWPWinAniMethodDebug("XWPWinAni", "wani_wpMenuItemSelected");
    FUNCENTER();
    ...
    switch (ulMenuId)
    {
        ...
        default:
            return (XWPWinAni_parent_WPDataFile_wpMenuItemSelected(somSelf,
                                                                    hwndFrame,
                                                                   ulMenuId));
    }
...
SOM_Scope BOOL SOMLINK wani_wpMenuItemHelpSelected(XWPWinAni * somSelf,
                                                   ULONG MenuId)
{
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);
...
SOM_Scope void SOMLINK wani_wpInitData(XWPWinAni * somSelf)
{
    APIRET rc;
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);

    XWPWinAniMethodDebug("XWPWinAni", "wani_wpInitData");
    FUNCENTER();

    XWPWinAni_parent_WPDataFile_wpInitData(somSelf);
...
SOM_Scope void SOMLINK wani_wpUnInitData(XWPWinAni * somSelf)
{
    ULONG i;
    XWPWinAniData *somThis = XWPWinAniGetData(somSelf);
    ...
    if (_piconinfo)
        _wpFreeMem(somSelf, (PBYTE)_piconinfo);
    if (_pfs3)
        _wpFreeMem(somSelf, (PBYTE)_pfs3);
    if (_hptr)
        WinDestroyPointer(_hptr);
...
SOM_Scope ULONG SOMLINK waniM_wpclsQueryStyle(M_XWPWinAni * somSelf)
{
    // M_XWPWinAniData *somThis = M_XWPWinAniGetData(somSelf);

    M_XWPWinAniMethodDebug("M_XWPWinAni", "waniM_wpclsQueryStyle");

    return (M_XWPWinAni_parent_M_WPDataFile_wpclsQueryStyle(somSelf) & CLSSTYLE_NEVERTEMPLATE);
}

// ===========================================================================

SOM_Scope PSZ SOMLINK waniM_wpclsQueryInstanceFilter(M_XWPWinAni * somSelf)
{
    /* M_XWPWinAniData *somThis = M_XWPWinAniGetData(somSelf); */
    M_XWPWinAniMethodDebug("M_XWPWinAni", "waniM_wpclsQueryInstanceFilter");
    FUNCENTER();
...
SOM_Scope PSZ SOMLINK waniM_wpclsQueryInstanceType(M_XWPWinAni * somSelf)
{
    /* M_XWPWinAniData *somThis = M_XWPWinAniGetData(somSelf); */
    M_XWPWinAniMethodDebug("M_XWPWinAni", "waniM_wpclsQueryInstanceType");
    FUNCENTER();
...
SOM_Scope PSZ SOMLINK waniM_wpclsQueryTitle(M_XWPWinAni * somSelf)
{
    /* M_XWPWinAniData *somThis = M_XWPWinAniGetData(somSelf); */
    M_XWPWinAniMethodDebug("M_XWPWinAni", "waniM_wpclsQueryTitle");
    FUNCENTER();
...
SOM_Scope void SOMLINK waniM_wpclsInitData(M_XWPWinAni * somSelf)
{
    APIRET rc;

    // M_XWPWinAniData *somThis = M_XWPWinAniGetData(somSelf);

    M_XWPWinAniMethodDebug("M_XWPWinAni", "waniM_wpclsInitData");
    FUNCENTER();

    M_XWPWinAni_parent_M_WPDataFile_wpclsInitData(somSelf);
...
SOM_Scope void SOMLINK waniM_wpclsUnInitData(M_XWPWinAni * somSelf)
{
    ...
    M_XWPWinAniMethodDebug("M_XWPWinAni", "waniM_wpclsUnInitData");
    FUNCENTER();
    ...
    M_XWPWinAni_parent_M_WPDataFile_wpclsUnInitData(somSelf);
}
...
MRESULT EXPENTRY wpwani_NotebookPageProc(HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2)
{
    ...
    if (pwd)
    {
        ...
        somSelf = pwd->somSelf;
        somThis = XWPWinAniGetData(somSelf);
    }
                        ...
                        case IDDLG_DLG_ICONPAGE:
                            {
                                ...
                                // set title
                                DLGSETSTRING(hwnd, IDDLG_ME_TITLE, _wpclsQueryTitle(_XWPWinAni));

                                // mark title field as unchanged
                                DLGQUERYCHANGED(hwnd, IDDLG_ME_TITLE);

                                // query style
                                ulStyle = _wpclsQueryStyle(_XWPWinAni);
                                _wpSetStyle(somSelf, ulStyle);
