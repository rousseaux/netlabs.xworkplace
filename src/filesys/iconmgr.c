 ...
 *
 *@@added V0.9.20 (2002-07-25) [umoeller]
 *@@changed V1.0.10 (2013-03-16) [pr]: Rewrote to ignore crashes @@fixes 336
 */
    ...
    for(;;)
    {
        ...
        if (LockLazyIcons())
        {
            ...
            do
            {
                ...
                // list LIFO by taking the object off
