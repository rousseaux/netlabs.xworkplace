            ...
            do
            {
                ...
                if (fTrapped)
                    if (pszErrMsg == NULL)
                    {
                        ...
                        {
                            strcpy(pszErrMsg,
                                   "An error occurred in the XWorkplace Worker thread. "
...
void _Optlink fntFileThread(PTHREADINFO pti)
{
    ...
    CATCH(excpt1)
    {
        ...
        if (pszErrMsg == NULL)
        {
            ...
            {
                strcpy(pszErrMsg, "An error occurred in the XFolder File thread.\n"
...
void _Optlink fntBushThread(PTHREADINFO pti)
{
    ...
    CATCH(excpt1)
    {
        ...
        if (pszErrMsg == NULL)
        {
            ...
            if (pszErrMsg)
            {
                strcpy(pszErrMsg, "An error occurred in the XFolder Bush thread. "
