...
/*
 *@@sourcefile w_xbutton.c:
 *      XCenter "X-Button" widget implementation.
 ...
 *      fnwpXButtonWidget and stored in XCENTERWIDGETVIEW.pUser.
 */
...
/*
 *@@ BwgtCreate:
 *      implementation for WM_CREATE in fnwpXButtonWidget.
 */

MRESULT BwgtCreate(HWND hwnd, MPARAM mp1)
{
    MRESULT mrc = 0;
    ...
    pViewData->ulHelpPanelID = ID_XSH_WIDGET_XBUTTON_MAIN;
...
/*
 * BwgtPaintButton:
 *      implementation for WM_PAINT in fnwpXButtonWidget.
 */

VOID BwgtPaintButton(HWND hwnd)
{
    RECTL rclPaint;
...
/*
 * BwgtButton1Down:
 *      implementation for WM_BUTTON1DOWN in fnwpXButtonWidget.
 */

VOID BwgtButton1Down(HWND hwnd)
{
    // get widget data and its button data from QWL_USER
    PXCENTERWIDGETVIEW pViewData = (PXCENTERWIDGETVIEW)WinQueryWindowPtr(hwnd, QWL_USER);
    if (pViewData)
...
/*
 * BwgtButton1Up:
 *      implementation for WM_BUTTON1UP in fnwpXButtonWidget.
 */

VOID BwgtButton1Up(HWND hwnd)
{
    // get widget data and its button data from QWL_USER
    PXCENTERWIDGETVIEW pViewData = (PXCENTERWIDGETVIEW)WinQueryWindowPtr(hwnd, QWL_USER);
    if (pViewData)
...
/*
 * BwgtInitMenu:
 *      implementation for WM_INITMENU in fnwpXButtonWidget.
 */

VOID BwgtInitMenu(HWND hwnd, MPARAM mp1, MPARAM mp2)
{
    PCGLOBALSETTINGS pGlobalSettings = cmnQueryGlobalSettings();
...
/*
 * BwgtMenuEnd:
 *      implementation for WM_MENUEND in fnwpXButtonWidget.
 */

VOID BwgtMenuEnd(HWND hwnd, MPARAM mp2)
{
    // get widget data and its button data from QWL_USER
    PXCENTERWIDGETVIEW pViewData = (PXCENTERWIDGETVIEW)WinQueryWindowPtr(hwnd, QWL_USER);
    if (pViewData)
...
/*
 *@@ BwgtCommand:
 *      implementation for WM_COMMAND in fnwpXButtonWidget.
 */

BOOL BwgtCommand(HWND hwnd, MPARAM mp1)
{
