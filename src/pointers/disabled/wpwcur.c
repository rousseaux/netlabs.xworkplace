...
#ifndef SOM_Module_anwcur_Source
#define SOM_Module_anwcur_Source
#endif
#define XWPWinCursor_Class_Source
#define M_XWPWinCursor_Class_Source

// generic headers
#include "setup.h"              // code generation and debugging options

#include "pointers\anwcur.ih"
...
// prototypes
MRESULT EXPENTRY anwcur_NotebookPageProc(HWND hwndDlg, ULONG msg, MPARAM mp1, MPARAM mp2);

// ===========================================================================

SOM_Scope void SOMLINK wcur_wpRefreshFileIcon(XWPWinCursor * somSelf)
{
    ...
    XWPWinCursorData *somThis = XWPWinCursorGetData(somSelf);

    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpRefreshFileIcon");
    FUNCENTER();
    ...
    do
    {
        ...
        if (hptr)
        {
            ...
            XWPWinCursor_parent_WPDataFile_wpSetIcon(somSelf, hptr);
...
SOM_Scope ULONG SOMLINK wcur_wpGetAnimationTimeframeValue(XWPWinCursor * somSelf)
{
    XWPWinCursorData *somThis = XWPWinCursorGetData(somSelf);

    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpGetAnimationTimeframeValue");
    FUNCENTER();
...
SOM_Scope BOOL SOMLINK wcur_wpSetAnimationTimeframeValue(XWPWinCursor * somSelf,
                                                         ULONG ulNewValue)
{
    XWPWinCursorData *somThis = XWPWinCursorGetData(somSelf);

    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpSetAnimationTimeframeValue");
    FUNCENTER();
...
SOM_Scope ULONG SOMLINK wcur_InsertAnimationPage1(XWPWinCursor * somSelf,
                                                  HWND hwndDlg)
{
    PAGEINFO pi;
    ...
    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_InsertAnimationPage");
    FUNCENTER();
    ...
    pi.pfnwp = anwcur_NotebookPageProc;
...
SOM_Scope ULONG SOMLINK wcur_InsertAnimationPage2(XWPWinCursor * somSelf,
                                                  HWND hwndDlg)
{
    PAGEINFO pi;
    CHAR szTabName[MAX_RES_STRLEN];
    ...
    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_InsertAnimationPage2");
...
SOM_Scope ULONG SOMLINK wcur_InsertAnimationPage3(XWPWinCursor * somSelf,
                                                  HWND hwndDlg)
{
    XWPWinCursorData *somThis = XWPWinCursorGetData(somSelf);

    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_InsertAnimationPage3");
...
SOM_Scope ULONG SOMLINK wcur_wpAddFile1Page(XWPWinCursor * somSelf,
                                            HWND hwndNotebook)
{
    ULONG ulResult;
    XWPWinCursorData *somThis = XWPWinCursorGetData(somSelf);

    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpAddFile1Page");

    _InsertAnimationPage2(somSelf, hwndNotebook);
    _InsertAnimationPage1(somSelf, hwndNotebook);

    ulResult = XWPWinCursor_parent_WPDataFile_wpAddFile1Page(somSelf,
                                                            hwndNotebook);
...
SOM_Scope ULONG SOMLINK wcur_wpAddObjectGeneralPage(XWPWinCursor * somSelf,
                                                    HWND hwndNotebook)
{
    PAGEINFO pi;
    CHAR szTabName[MAX_RES_STRLEN];
    ...
    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpAddObjectGeneralPage");
    FUNCENTER();
...
SOM_Scope void SOMLINK wcur_wpObjectReady(XWPWinCursor * somSelf,
                                          ULONG ulCode, WPObject * refObject)
{
    XWPWinCursorData *somThis = XWPWinCursorGetData(somSelf);

    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpObjectReady");
    FUNCENTER();

    XWPWinCursor_parent_WPDataFile_wpObjectReady(somSelf, ulCode,
                                                refObject);
...
SOM_Scope HPOINTER SOMLINK wcur_wpQueryIcon(XWPWinCursor * somSelf)
{
    ...
    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpQueryIcon");
    FUNCENTER();
    ...
    return (XWPWinCursor_parent_WPDataFile_wpQueryIcon(somSelf));
}

// ===========================================================================

SOM_Scope ULONG SOMLINK wcur_wpQueryIconData(XWPWinCursor * somSelf,
                                             PICONINFO pIconInfo)
{
    XWPWinCursorData *somThis = XWPWinCursorGetData(somSelf);

    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpQueryIconData");
    FUNCENTER();
    ...
    return (XWPWinCursor_parent_WPDataFile_wpQueryIconData(somSelf,
                                                          pIconInfo));
}

// ===========================================================================

SOM_Scope BOOL SOMLINK wcur_wpSetIcon(XWPWinCursor * somSelf,
                                      HPOINTER hptrNewIcon)
{
    XWPWinCursorData *somThis = XWPWinCursorGetData(somSelf);

    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpSetIcon");
    FUNCENTER();
    ...
    return (XWPWinCursor_parent_WPDataFile_wpSetIcon(somSelf,
                                                    hptrNewIcon));
}

// ===========================================================================

SOM_Scope BOOL SOMLINK wcur_wpSetIconData(XWPWinCursor * somSelf,
                                          PICONINFO pIconInfo)
{
    XWPWinCursorData *somThis = XWPWinCursorGetData(somSelf);

    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpSetIconData");
    FUNCENTER();
    ...
    return (XWPWinCursor_parent_WPDataFile_wpSetIconData(somSelf,
                                                        pIconInfo));
}

// ===========================================================================

SOM_Scope BOOL SOMLINK wcur_wpModifyPopupMenu(XWPWinCursor * somSelf,
                                              HWND hwndMenu,
                                              HWND hwndCnr,
                                              ULONG iPosition)
{
    ...
    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpModifyPopupMenu");
    FUNCENTER();
    ...
    fSuccess =
        _wpInsertPopupMenuItems(somSelf, hwndMenu, 0,
                                _clsQueryResourceModuleHandle(_XWPWinCursor),
    ...
    return (XWPWinCursor_parent_WPDataFile_wpModifyPopupMenu(somSelf,
                                                            hwndMenu,
                                                            hwndCnr,
                                                            iPosition));
}
...
SOM_Scope ULONG SOMLINK wcur_wpFilterPopupMenu(XWPWinCursor * somSelf,
                                               ULONG ulFlags,
                                               HWND hwndCnr,
                                               BOOL fMultiSelect)
{
    ...
    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpFilterPopupMenu");

    ulFlags &= ~CTXT_PRINT;

    return (XWPWinCursor_parent_WPDataFile_wpFilterPopupMenu(somSelf,
                                                            ulFlags,
                                                            hwndCnr,
                                                            fMultiSelect));
}
...
SOM_Scope BOOL SOMLINK wcur_wpMenuItemSelected(XWPWinCursor * somSelf,
                                               HWND hwndFrame,
                                               ULONG ulMenuId)
{
    ...
    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpMenuItemSelected");
    FUNCENTER();
    ...
    switch (ulMenuId)
    {
        ...
        default:
            return (XWPWinCursor_parent_WPDataFile_wpMenuItemSelected(somSelf,
                                                                     hwndFrame,
                                                                   ulMenuId));
    }
...
SOM_Scope BOOL SOMLINK wcur_wpMenuItemHelpSelected(XWPWinCursor * somSelf,
                                                   ULONG MenuId)
{
    XWPWinCursorData *somThis = XWPWinCursorGetData(somSelf);

    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpMenuItemHelpSelected");
    FUNCENTER();

    // ###
    return (XWPWinCursor_parent_WPDataFile_wpMenuItemHelpSelected(somSelf,
                                                                 MenuId));
}

// ===========================================================================

SOM_Scope void SOMLINK wcur_wpInitData(XWPWinCursor * somSelf)
{
    APIRET rc;
    XWPWinCursorData *somThis = XWPWinCursorGetData(somSelf);

    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpInitData");
    FUNCENTER();

    XWPWinCursor_parent_WPDataFile_wpInitData(somSelf);
...
SOM_Scope void SOMLINK wcur_wpUnInitData(XWPWinCursor * somSelf)
{
    ULONG i;
    XWPWinCursorData *somThis = XWPWinCursorGetData(somSelf);

    XWPWinCursorMethodDebug("XWPWinCursor", "wcur_wpUnInitData");
    FUNCENTER();

    XWPWinCursor_parent_WPDataFile_wpUnInitData(somSelf);    // ###
...
SOM_Scope HMODULE SOMLINK wcur_MclsQueryResourceModuleHandle(M_XWPWinCursor * somSelf)
{
    M_XWPWinCursorData *somThis = M_XWPWinCursorGetData(somSelf);

    M_XWPWinCursorMethodDebug("M_XWPWinCursor", "wcur_MclsQueryResourceModuleHandle");
    FUNCENTER();
...
SOM_Scope PSZ SOMLINK wcur_MclsQueryHelpLibrary(M_XWPWinCursor * somSelf)
{
    M_XWPWinCursorData *somThis = M_XWPWinCursorGetData(somSelf);

    M_XWPWinCursorMethodDebug("M_XWPWinCursor", "wcur_MclsQueryHelpLibrary");
    FUNCENTER();

    return _szHelpLibrary;
}

SOM_Scope ULONG SOMLINK wcur_MwpclsQueryStyle(M_XWPWinCursor * somSelf)
{
    M_XWPWinCursorData *somThis = M_XWPWinCursorGetData(somSelf);

    M_XWPWinCursorMethodDebug("M_XWPWinCursor", "wcur_MwpclsQueryStyle");

    return (M_XWPWinCursor_parent_M_WPDataFile_wpclsQueryStyle(somSelf) & CLSSTYLE_NEVERTEMPLATE);
}

// ===========================================================================

SOM_Scope PSZ SOMLINK wcur_MwpclsQueryInstanceFilter(M_XWPWinCursor * somSelf)
{
    /* M_XWPWinCursorData *somThis = M_XWPWinCursorGetData(somSelf); */
    M_XWPWinCursorMethodDebug("M_XWPWinCursor", "wcur_MwpclsQueryInstanceFilter");
    FUNCENTER();
...
SOM_Scope PSZ SOMLINK wcur_MwpclsQueryInstanceType(M_XWPWinCursor * somSelf)
{
    /* M_XWPWinCursorData *somThis = M_XWPWinCursorGetData(somSelf); */
    M_XWPWinCursorMethodDebug("M_XWPWinCursor", "wcur_MwpclsQueryInstanceType");
    FUNCENTER();
...
SOM_Scope PSZ SOMLINK wcur_MwpclsQueryTitle(M_XWPWinCursor * somSelf)
{
    /* M_XWPWinCursorData *somThis = M_XWPWinCursorGetData(somSelf); */
    M_XWPWinCursorMethodDebug("M_XWPWinCursor", "wcur_MwpclsQueryTitle");
    FUNCENTER();
...
SOM_Scope void SOMLINK wcur_MwpclsInitData(M_XWPWinCursor * somSelf)
{
    APIRET rc;

    M_XWPWinCursorData *somThis = M_XWPWinCursorGetData(somSelf);

    M_XWPWinCursorMethodDebug("M_XWPWinCursor", "wcur_MwpclsInitData");
    FUNCENTER();

    M_XWPWinCursor_parent_M_WPDataFile_wpclsInitData(somSelf);
...
SOM_Scope void SOMLINK wcur_MwpclsUnInitData(M_XWPWinCursor * somSelf)
{
    ...
    M_XWPWinCursorMethodDebug("M_XWPWinCursor", "wcur_MwpclsUnInitData");
    FUNCENTER();
    ...
    M_XWPWinCursor_parent_M_WPDataFile_wpclsUnInitData(somSelf);
}
...
MRESULT EXPENTRY anwcur_NotebookPageProc(HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2)
{
    ...
    if (pwd)
    {
        ...
        somSelf = pwd->somSelf;
        somThis = XWPWinCursorGetData(somSelf);
    }
                        ...
                        case IDDLG_DLG_ICONPAGE:
                            {
                                ...
                                // set title
                                DLGSETSTRING(hwnd, IDDLG_ME_TITLE, _wpclsQueryTitle(_XWPWinCursor));

                                // mark title field as unchanged
                                DLGQUERYCHANGED(hwnd, IDDLG_ME_TITLE);

                                // query style
                                ulStyle = _wpclsQueryStyle(_XWPWinCursor);
                                _wpSetStyle(somSelf, ulStyle);
