...
#ifndef SOM_Module_wpwani_Source
#define SOM_Module_wpwani_Source
#endif
#define WPWinAnimation_Class_Source
#define M_WPWinAnimation_Class_Source

// generic headers
#include "setup.h"              // code generation and debugging options

#include "pointers\wpwani.ih"
...
// prototypes
MRESULT EXPENTRY wpwani_NotebookPageProc(HWND hwndDlg, ULONG msg, MPARAM mp1, MPARAM mp2);

// ===========================================================================

SOM_Scope void SOMLINK wani_wpRefreshFileIcon(WPWinAnimation * somSelf)
{
    ...
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpRefreshFileIcon");
    FUNCENTER();
    ...
    do
    {
        ...
        fSuccess = LoadFirstPointerFromWinAnimationFile(szFilename, &hptr, &iconinfo);
        ...
        if (hptr)
        {
            ...
            WPWinAnimation_parent_WPDataFile_wpSetIcon(somSelf, hptr);
        ...
        fSuccess = LoadFirstAnimationFromWinAnimationFile(szFilename,
                                                          ahptr,
                                                          aulTimeout,
                                                          &ulEntries);
...
SOM_Scope ULONG SOMLINK wani_wpGetAnimationTimeframeValue(WPWinAnimation * somSelf)
{
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpGetAnimationTimeframeValue");
    FUNCENTER();
...
SOM_Scope BOOL SOMLINK wani_wpSetAnimationTimeframeValue(WPWinAnimation * somSelf,
                                                         ULONG ulNewValue)
{
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpSetAnimationTimeframeValue");
    FUNCENTER();
...
SOM_Scope ULONG SOMLINK wani_InsertAnimationPage1(WPWinAnimation * somSelf,
                                                  HWND hwndDlg)
{
    PAGEINFO pi;
    ...
    WPWinAnimationMethodDebug("WPWinAnimation", "wani_InsertAnimationPage");
    FUNCENTER();
    ...
    pi.pfnwp = wpwani_NotebookPageProc;
...
SOM_Scope ULONG SOMLINK wani_InsertAnimationPage2(WPWinAnimation * somSelf,
                                                  HWND hwndDlg)
{
    PAGEINFO pi;
    CHAR szTabName[MAX_RES_STRLEN];
    ...
    WPWinAnimationMethodDebug("WPWinAnimation", "wani_InsertAnimationPage2");
...
SOM_Scope ULONG SOMLINK wani_InsertAnimationPage3(WPWinAnimation * somSelf,
                                                  HWND hwndDlg)
{
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_InsertAnimationPage3");
...
SOM_Scope ULONG SOMLINK wani_wpAddFile1Page(WPWinAnimation * somSelf,
                                            HWND hwndNotebook)
{
    ULONG ulResult;
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpAddFile1Page");

    _InsertAnimationPage2(somSelf, hwndNotebook);
    _InsertAnimationPage1(somSelf, hwndNotebook);

    ulResult = WPWinAnimation_parent_WPDataFile_wpAddFile1Page(somSelf,
                                                               hwndNotebook);
...
SOM_Scope ULONG SOMLINK wani_wpAddObjectGeneralPage(WPWinAnimation * somSelf,
                                                    HWND hwndNotebook)
{
    PAGEINFO pi;
    CHAR szTabName[MAX_RES_STRLEN];
    ...
    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpAddObjectGeneralPage");
    FUNCENTER();
...
SOM_Scope void SOMLINK wani_wpObjectReady(WPWinAnimation * somSelf,
                                          ULONG ulCode, WPObject * refObject)
{
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpObjectReady");
    FUNCENTER();

    WPWinAnimation_parent_WPDataFile_wpObjectReady(somSelf, ulCode,
                                                   refObject);
...
SOM_Scope HPOINTER SOMLINK wani_wpQueryIcon(WPWinAnimation * somSelf)
{
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpQueryIcon");
    FUNCENTER();
    ...
    return (WPWinAnimation_parent_WPDataFile_wpQueryIcon(somSelf));
}

// ===========================================================================

SOM_Scope ULONG SOMLINK wani_wpQueryIconData(WPWinAnimation * somSelf,
                                             PICONINFO pIconInfo)
{
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpQueryIconData");
    FUNCENTER();
    ...
    return (WPWinAnimation_parent_WPDataFile_wpQueryIconData(somSelf,
                                                             pIconInfo));
}

// ===========================================================================

SOM_Scope BOOL SOMLINK wani_wpSetIcon(WPWinAnimation * somSelf,
                                      HPOINTER hptrNewIcon)
{
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpSetIcon");
    FUNCENTER();
    ...
    return (WPWinAnimation_parent_WPDataFile_wpSetIcon(somSelf,
                                                       hptrNewIcon));
}

// ===========================================================================

SOM_Scope BOOL SOMLINK wani_wpSetIconData(WPWinAnimation * somSelf,
                                          PICONINFO pIconInfo)
{
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpSetIconData");
    FUNCENTER();
    ...
    return (WPWinAnimation_parent_WPDataFile_wpSetIconData(somSelf,
                                                           pIconInfo));
}

// ===========================================================================

SOM_Scope BOOL SOMLINK wani_wpModifyPopupMenu(WPWinAnimation * somSelf,
                                              HWND hwndMenu,
                                              HWND hwndCnr,
                                              ULONG iPosition)
{
    ...
    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpModifyPopupMenu");
    FUNCENTER();
    ...
    fSuccess =
        _wpInsertPopupMenuItems(somSelf, hwndMenu, 0,
                                _clsQueryResourceModuleHandle(_WPWinAnimation),
    ...
    return (WPWinAnimation_parent_WPDataFile_wpModifyPopupMenu(somSelf,
                                                               hwndMenu,
                                                               hwndCnr,
                                                               iPosition));
}
...
SOM_Scope ULONG SOMLINK wani_wpFilterPopupMenu(WPWinAnimation * somSelf,
                                               ULONG ulFlags,
                                               HWND hwndCnr,
                                               BOOL fMultiSelect)
{
    ...
    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpFilterPopupMenu");

    ulFlags &= ~CTXT_PRINT;

    return (WPWinAnimation_parent_WPDataFile_wpFilterPopupMenu(somSelf,
                                                               ulFlags,
                                                               hwndCnr,
                                                               fMultiSelect));
}
...
SOM_Scope BOOL SOMLINK wani_wpMenuItemSelected(WPWinAnimation * somSelf,
                                               HWND hwndFrame,
                                               ULONG ulMenuId)
{
    ...
    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpMenuItemSelected");
    FUNCENTER();
    ...
    switch (ulMenuId)
    {
        ...
        default:
            return (WPWinAnimation_parent_WPDataFile_wpMenuItemSelected(somSelf,
                                                                    hwndFrame,
                                                                   ulMenuId));
    }
...
SOM_Scope BOOL SOMLINK wani_wpMenuItemHelpSelected(WPWinAnimation * somSelf,
                                                   ULONG MenuId)
{
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpMenuItemHelpSelected");
    FUNCENTER();

    // ###
    return (WPWinAnimation_parent_WPDataFile_wpMenuItemHelpSelected(somSelf,
                                                                    MenuId));
}

// ===========================================================================

SOM_Scope void SOMLINK wani_wpInitData(WPWinAnimation * somSelf)
{
    APIRET rc;
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpInitData");
    FUNCENTER();

    WPWinAnimation_parent_WPDataFile_wpInitData(somSelf);
...
SOM_Scope void SOMLINK wani_wpUnInitData(WPWinAnimation * somSelf)
{
    ULONG i;
    WPWinAnimationData *somThis = WPWinAnimationGetData(somSelf);

    WPWinAnimationMethodDebug("WPWinAnimation", "wani_wpUnInitData");
    FUNCENTER();

    WPWinAnimation_parent_WPDataFile_wpUnInitData(somSelf);     // ###
...
SOM_Scope HMODULE SOMLINK wani_MclsQueryResourceModuleHandle(M_WPWinAnimation * somSelf)
{
    M_WPWinAnimationData *somThis = M_WPWinAnimationGetData(somSelf);

    M_WPWinAnimationMethodDebug("M_WPWinAnimation", "wani_MclsQueryResourceModuleHandle");
    FUNCENTER();
...
SOM_Scope PSZ SOMLINK wani_MclsQueryHelpLibrary(M_WPWinAnimation * somSelf)
{
    M_WPWinAnimationData *somThis = M_WPWinAnimationGetData(somSelf);

    M_WPWinAnimationMethodDebug("M_WPWinAnimation", "wani_MclsQueryHelpLibrary");
    FUNCENTER();

    return _szHelpLibrary;
}

SOM_Scope ULONG SOMLINK wani_MwpclsQueryStyle(M_WPWinAnimation * somSelf)
{
    M_WPWinAnimationData *somThis = M_WPWinAnimationGetData(somSelf);

    M_WPWinAnimationMethodDebug("M_WPWinAnimation", "wani_MwpclsQueryStyle");

    return (M_WPWinAnimation_parent_M_WPDataFile_wpclsQueryStyle(somSelf) & CLSSTYLE_NEVERTEMPLATE);
}

// ===========================================================================

SOM_Scope PSZ SOMLINK wani_MwpclsQueryInstanceFilter(M_WPWinAnimation * somSelf)
{
    /* M_WPWinAnimationData *somThis = M_WPWinAnimationGetData(somSelf); */
    M_WPWinAnimationMethodDebug("M_WPWinAnimation", "wani_MwpclsQueryInstanceFilter");
    FUNCENTER();

    return (FILEFILTER_WINANIMATION);
}

// ===========================================================================

SOM_Scope PSZ SOMLINK wani_MwpclsQueryInstanceType(M_WPWinAnimation * somSelf)
{
    /* M_WPWinAnimationData *somThis = M_WPWinAnimationGetData(somSelf); */
    M_WPWinAnimationMethodDebug("M_WPWinAnimation", "wani_MwpclsQueryInstanceType");
    FUNCENTER();

    return (FILETYPE_WINANIMATION);
}

// ===========================================================================

SOM_Scope PSZ SOMLINK wani_MwpclsQueryTitle(M_WPWinAnimation * somSelf)
{
    /* M_WPWinAnimationData *somThis = M_WPWinAnimationGetData(somSelf); */
    M_WPWinAnimationMethodDebug("M_WPWinAnimation", "wani_MwpclsQueryTitle");
    FUNCENTER();
...
SOM_Scope void SOMLINK wani_MwpclsInitData(M_WPWinAnimation * somSelf)
{
    APIRET rc;

    M_WPWinAnimationData *somThis = M_WPWinAnimationGetData(somSelf);

    M_WPWinAnimationMethodDebug("M_WPWinAnimation", "wani_MwpclsInitData");
    FUNCENTER();

    M_WPWinAnimation_parent_M_WPDataFile_wpclsInitData(somSelf);
...
SOM_Scope void SOMLINK wani_MwpclsUnInitData(M_WPWinAnimation * somSelf)
{
    ...
    M_WPWinAnimationMethodDebug("M_WPWinAnimation", "wani_MwpclsUnInitData");
    FUNCENTER();
    ...
    M_WPWinAnimation_parent_M_WPDataFile_wpclsUnInitData(somSelf);
}
...
MRESULT EXPENTRY wpwani_NotebookPageProc(HWND hwnd, ULONG msg, MPARAM mp1, MPARAM mp2)
{

    PWPSWINDOWDATA pwd = WinQueryWindowPtr(hwnd, QWL_USER);
    SOMAny *somSelf;
    WPWinAnimationData *somThis;
    APIRET rc = NO_ERROR;
    BOOL fSuccess = FALSE;
    ...
    if (pwd)
    {
        ...
        somSelf = pwd->somSelf;
        somThis = WPWinAnimationGetData(somSelf);
    }
                        ...
                        case IDDLG_DLG_ANIMATIONPAGE1:
                            {
                                ...
                                do
                                {
                                    ...
                                    // Grî·e ermitteln
                                    QueryWinAnimationFileDetails(szFilename, FI_SOURCEINFO, NULL, 0, &ulSourceInfoLen);
                                    ...
                                    rc = QueryWinAnimationFileDetails(szFilename, FI_SOURCEINFO, psourceinfo, ulSourceInfoLen, &ulSourceInfoLen);
                        ...
                        case IDDLG_DLG_ICONPAGE:
                            {
                                ...
                                // set title
                                DLGSETSTRING(hwnd, IDDLG_ME_TITLE, _wpclsQueryTitle(_WPWinAnimation));

                                // mark title field as unchanged
                                DLGQUERYCHANGED(hwnd, IDDLG_ME_TITLE);

                                // query style
                                ulStyle = _wpclsQueryStyle(_WPWinAnimation);
                                _wpSetStyle(somSelf, ulStyle);
                    ...
                    case IDDLG_DLG_ANIMATIONPAGE1:
                        {
                            ...
                            if ((fNameChanged) || (fArtistChanged))
                            {
                                ...
                                // Attribute setzen
                                rc = SetWinAnimationFileInfo(szFilename, &sourceinfo);
                                if (rc != NO_ERROR)
                                {
