...
#define link_peer "<A HREF=\"glossary/gls_peer.html\">File and Print Client</A>"
...
// (note, plural) with
// &link_folders;
#define link_folders "<A HREF=\"objects/obj_fdr_main.html\">folders</A>"
// for the xwphelp2 dir, replace all occurences of
// <A HREF="objects/obj_dataf.html">data files</A>
// (note, plural) with
// &link_datafiles;
#define link_datafiles "<A HREF=\"objects/obj_dataf.html\">data files</A>"
