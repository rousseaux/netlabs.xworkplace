...
/* Config Folder title */
ConfigFolder        = XWorkplace||" Konfigurationsmapp";
/* here come the objects in the config folder */
CommandLines        = "~Kommandosessioner";
OS2Win              = "~"||OS2||" f”nster";
OS2Fullscreen       = OS2||" ~fullsk„rm";
DosWin              = "~DOS f”nster";
DOSFullscreen       = "DOS f~ullsk„rm";
CreateAnother       = "Skapa ~ny";
Folder              = "Mapp";
    /* the following three were added with V0.9.16 */
URLFolder           = "URL Mapp";
DataFile            = "Datafil";
ProgramObject       = "Programobjekt";
QuickSettings       = "~Snabba Inst„llningar";
DefaultView         = "S~tandardvisning f”r mappen";
IconView            = "Ikonvisning";
TreeView            = "Tr„dvisning";
DetailsView         = "Detaljvisning";
SmallIcons          = "Sm† ikoner f”r Ikon och Tr„dvisning";
NormalIcons         = "Normala ikoner f”r Ikon och Tr„dvisning";
ShowAllInTreeView   = "Visa alla objekt i Tr„dvisning";
...
OnlineReference     = XWorkplace||" Anv„ndarguide";
Treesize            = "Tr„dstorlek";
PackTree            = "Packa det h„r tr„det";
